...
//       <h1 className="text-3xl font-bold mb-6">Active 
//         <span className="text-[#F47521]"> {currentUser?.organisation}</span>
//       </h1>
...
function AllMembersPage() {
  ...
  const [error, setError] = useState<string | null>(null)
  const [searchQuery, setSearchQuery] = useState("")
  const [currentUser, setCurrentUser] = useState<User | null>(null) // Added state for currentUser
