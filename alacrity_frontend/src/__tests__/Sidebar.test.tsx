...
describe("Sidebar", () => {
  ...
  // it("renders NavItems with correct userRole", () => {
  //   render(<Sidebar {...defaultProps} userRole="organization_admin" />);
  //   expect(screen.getByTestId("nav-items")).toHaveTextContent("Mock NavItems: admin");
  // });
});