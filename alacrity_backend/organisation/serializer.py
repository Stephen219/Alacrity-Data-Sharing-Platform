...
class OrganizationSerializer(serializers.ModelSerializer):
    ...
    field = serializers.CharField(max_length=100, required=True, allow_blank=True, allow_null=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            'is_followed', 'social_links', 'email', 'phone', 'address', 'admin', 'description' , 'field'
        ]
