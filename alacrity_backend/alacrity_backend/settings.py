...
env = environ.Env(
    ...
    DJANGO_DATABASE_USER=(str, 'alacrity'),  # Changed from 'root' for security
    DJANGO_DATABASE_PASSWORD=(str, 'your-db-password'),  # Use secure password
    DJANGO_DATABASE_HOST=(str, 'localhost'),  # Changed to localhost for deployment
...
DEBUG = env('DEBUG')
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['10.72.102.171', 'localhost', '127.0.0.1'])

# Application definition
INSTALLED_APPS = [
    'daphne',  # Move daphne first for ASGI
    'channels',
    'channels_redis',
    'corsheaders',
...
CORS_ALLOWED_ORIGINS = env.list('CORS_ALLOWED_ORIGINS', default=[
    'http://10.72.102.244',  # Frontend URL
    'http://10.72.102.244:80',  # Explicit port
...
PAYPAL_RETURN_URL = env('PAYPAL_RETURN_URL', default='http://10.72.102.244/payments/paypal/success/')
PAYPAL_CANCEL_URL = env('PAYPAL_CANCEL_URL', default='http://10.72.102.244/payments/paypal/cancel/')