...
from .views import (Make_request, user_requests,View_pending,request_actions,view_requests)
...
urlpatterns = [ 
    ...
    path('requestaction/<str:id>/', request_actions.as_view(), name='request_actions'),
     ...
     path('userrequests/', user_requests.as_view(), name='user-dataset-requests'),
