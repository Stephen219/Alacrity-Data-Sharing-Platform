...
from .views import (Make_request,ViewAllDatasetRequests,AcceptRejectRequest, UserDatasetRequestsView)
...
urlpatterns = [ 
    ...
    path('userrequests/', UserDatasetRequestsView.as_view(), name='user_requests'),
